...
--
-- [Note] `tail` is taken because Utils.fibonacciSequence gives [1,1,2,3,5,...]
...
prob004 :: Int
prob004 = maximum [ k | i <- [900..999],
                        j <- [i..999],
                        let k = i * j,
                        Utils.isPalindrome k ]
...
diffSumSquared n = (simpleSum n)^2 - squaredSum n
    where simpleSum k  = (k * (k + 1)) `div` 2
          squaredSum k = (k * (k + 1) * (2 * k + 1)) `div` 6
...
data008 :: String
data008 = "7316717653133062491922511967442657474235534919493496983520" ++
          ...
          ""
